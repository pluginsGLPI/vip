...
------------
Ce plugin permet d'indiquer dans l'interface du ticket si le demandeur du ticket fait partie d'un groupe explicite (exemple : VIP) : 
...
This plugin allows you to indicate in the ticket interface if the ticket requester belongs to a explicite group (example : VIP) : 
